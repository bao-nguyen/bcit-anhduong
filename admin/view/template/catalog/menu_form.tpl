                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="menu_layout[0]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
                          <?php if (isset($menu_layout[0]) && $menu_layout[0] == $layout['layout_id']) { ?>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><select name="menu_layout[<?php echo $store['store_id']; ?>]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
                          <?php if (isset($menu_layout[$store['store_id']]) && $menu_layout[$store['store_id']] == $layout['layout_id']) { ?>
                          <option value="<?php echo $layout['layout_id']; ?>" selected="selected"><?php echo $layout['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>
                          <?php } ?>
...
$('input[name=\'filter\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#menu-filter' + item['value']).remove();

		$('#menu-filter').append('<div id="menu-filter' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="menu_filter[]" value="' + item['value'] + '" /></div>');
	}
});

$('#menu-filter').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script> 
  <script type="text/javascript"><!--
