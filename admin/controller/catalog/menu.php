...
class ControllerCatalogMenu extends Controller {
	...
	public function index() {
		$this->language->load('catalog/menu');
	...
	protected function getList() {
		...
		$results = $this->model_catalog_menu->getmenus(	);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['menu_layout'])) {
			$data['menu_layout'] = $this->request->post['menu_layout'];
		} elseif (isset($this->request->get['menu_id'])) {
			$data['menu_layout'] = $this->model_catalog_menu->getmenuLayouts($this->request->get['menu_id']);
		} else {
			$data['menu_layout'] = array();
		}
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['keyword']) > 0) {
			...
			if ($url_alias_info && isset($this->request->get['menu_id']) && $url_alias_info['query'] != 'menu_id=' . $this->request->get['menu_id']) {
				$this->error['keyword'] = sprintf($this->language->get('error_keyword'));
			}

			if ($url_alias_info && !isset($this->request->get['menu_id'])) {
				$this->error['keyword'] = sprintf($this->language->get('error_keyword'));
			}
