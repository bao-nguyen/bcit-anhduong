      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-ncategory"><?php echo $entry_ncategory; ?></label>
                <input type="text" name="filter_ncategory" value="<?php echo $filter_ncategory; ?>" placeholder="<?php echo $entry_ncategory; ?>" id="input-ncategory" class="form-control" />
              </div>
...
$('#button-filter').on('click', function() {
	...
	var filter_ncategory = $('input[name=\'filter_ncategory\']').val();

	if (filter_ncategory) {
		url += '&filter_ncategory=' + encodeURIComponent(filter_ncategory);
	}
...
$('input[name=\'filter_ncategory\']').autocomplete({
	'source': function(request, response) {
		$.ajax({			
