            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <option value="banner" selected="selected"><?php echo $text_banner; ?></option>
                    <?php } else { ?>
                    <option value="banner"><?php echo $text_banner; ?></option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'logo') { ?>
                    <option value="logo" selected="selected"><?php echo $text_logo; ?></option>
                    <?php } else { ?>
                    <option value="logo"><?php echo $text_logo; ?></option>
                    <?php } ?>
                    ...
                    <?php if ($layout_module['position'] == 'content1l') { ?>
                    <option value="content1l" selected="selected"><?php echo $text_content1_left; ?></option>
                    <?php } else { ?>
                    <option value="content1l"><?php echo $text_content1_left; ?></option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content1c') { ?>
                    <option value="content1c" selected="selected"><?php echo $text_content1_center; ?></option>
                    <?php } else { ?>
                    <option value="content1c"><?php echo $text_content1_center; ?></option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content1r') { ?>
                    <option value="content1r" selected="selected"><?php echo $text_content1_right; ?></option>
                    <?php } else { ?>
                    <option value="content1r"><?php echo $text_content1_right; ?></option>
                    <?php } ?>
                    
                    <?php if ($layout_module['position'] == 'content2_left') { ?>
                    <option value="content2_left" selected="selected"><?php echo $text_content2_left; ?></option>
                    <?php } else { ?>
                    <option value="content2_left"><?php echo $text_content2_left; ?></option>
                    <?php } ?>                    
                    <?php if ($layout_module['position'] == 'content2_right') { ?>
                    <option value="content2_right" selected="selected"><?php echo $text_content2_right; ?></option>
                    <?php } else { ?>
                    <option value="content2_right"><?php echo $text_content2_right; ?></option>
                    <?php } ?>
                    
                    <?php if ($layout_module['position'] == 'content3_left') { ?>
                    ...
                    <?php } else { ?>
                    <option value="content3_right"><?php echo $text_content3_right; ?></option>
                    <?php } ?>
                    <!-- End Them moi -->
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="logo"><?php echo $text_logo; ?></option>';
    html += '    <option value="banner"><?php echo $text_banner; ?></option>';
    html += '    <option value="menu"><?php echo $text_menu; ?></option>';
    
    html += '    <option value="content1l"><?php echo $text_content1_left; ?></option>';
    html += '    <option value="content1c"><?php echo $text_content1_center; ?></option>';
    html += '    <option value="content1r"><?php echo $text_content1_right; ?></option>';
