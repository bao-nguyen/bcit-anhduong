...
class ControllerCatalogContact extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('catalog/contact', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('catalog/contact/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$results = $this->model_catalog_contact->getContacts();
		...
		foreach ($results as $result) {
			$data['contacts'][] = array(
				...
				'delete'      => $this->url->link('catalog/contact/delete', 'token=' . $this->session->data['token'] . '&contact_id=' . $result['contact_id'] . $url, 'SSL')
			);
		}
		...
		$this->response->setOutput($this->load->view('catalog/contact_list.tpl', $data));
	}
