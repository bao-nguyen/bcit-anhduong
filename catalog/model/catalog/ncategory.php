...
class ModelCatalogncategory extends Model {
	...
	public function getncategoryFilters($ncategory_id) {
		...
		$query = $this->db->query("SELECT filter_id FROM " . DB_PREFIX . "ncategory_filter WHERE ncategory_id = '" . (int)$ncategory_id . "'");
	...
	public function getTotalCategoriesByncategoryId($parent_id = 0) {
